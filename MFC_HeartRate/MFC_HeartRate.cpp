...
BEGIN_MESSAGE_MAP(CMFC_HeartRateApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFC_HeartRateApp 建構

CMFC_HeartRateApp::CMFC_HeartRateApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_HeartRateApp 物件

CMFC_HeartRateApp theApp;


// CMFC_HeartRateApp 初始設定

BOOL CMFC_HeartRateApp::InitInstance()
{
